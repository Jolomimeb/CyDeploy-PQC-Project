...
threading.Thread(target= client_connect, args= (client1_socket_info, "P")).start()
threading.Thread(target= client_connect, args= (client2_socket_info, "H")).start()
threading.Thread(target= client_connect, args= (client3_socket_info, "P")).start()
threading.Thread(target= client_connect, args= (client4_socket_info, "H")).start()
threading.Thread(target= client_connect, args= (client5_socket_info, "P")).start()
