...
#Takes serialized X25519 public key, reverts it back to X25519 public key object, generates secret with that and private key, and derives a secret with specified length
