...
with open("Discovery_With_Certificates/root_CA.txt", "w") as file:
    file.write(json.dumps(root_CA))

with open("Discovery_With_Certificates/intermediate_CA.txt", "w") as file:
...
with open("Discovery_With_Certificates/intermediate_private_key.txt", "w") as file:
